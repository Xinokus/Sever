...
export default function ProductCard({amount, id, onSale, regularPrice, cardPrice, img, name, star1, star2, star3, star4, star5, discount}){
            ...
            <div className={classes.card} key={id}>
                <div className={classes.image} style={{backgroundImage: "url("+img+")"}}>
                    <div className={classes.left}>
                        <div className={classes.amount}><img src={cart} alt="" /><p>{amount}</p></div>
                        <p style={onSale ? {} : {visibility: 'hidden'}} className={classes.discount}>{discount}</p>
                    </div>
