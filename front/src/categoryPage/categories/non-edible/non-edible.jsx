import classes from './non-edible.module.scss'
...
export default function NonEdible(){
    ...
    useEffect(()=>{
        ...
        document.title = 'Непродовольственные товары'
    })
            ...
            <main className={classes.main} style={showMoreState ? {height: '2065px'} : {height: '1326px'}}>
                <section className={classes.section} style={showMoreState ? {height: '1961px'} : {height: '1222px'}}>
                    <div className={classes.top}>
                        ...
                        <img src={arrowRight} alt="" />
                        <a href="/catalog/bread">Непродовольственные товары</a>
                    </div>
